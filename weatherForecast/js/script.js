...
let weatherAPIKey = "f07b140add361354ed7db608e0a0dd96";
...
searchInp.addEventListener("input", async () => {
  ...
  datalist.innerHTML = ""; //to remove previous search
  result.forEach((city) => {
...
let updateCurrentWeather = (data) => {
  //console.log(data);
  city.textContent = data.name + ", " + data.sys.country; //these we get from the console, availabel by API from the site
